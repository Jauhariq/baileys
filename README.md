...
[CLICK HERE](https://www.npmjs.com/package/baileys/v/4.5.8?activeTab=readme), BAILEYS VERSI PACKAGE

## Pemasangan
```
edit package.json anda
ubah menjadi "@adiwajshing/baileys": "github:jauhariq/baileys"
jika ingin versi npm
ubah menjadi "@adiwajshing/baileys": "npm:baileys@^4.5.8"
```
